...
**VORTEX public bileşenleri, güven sınırları ve sahiplik kapsamlı görev yaşam döngüsü**

[![Mimari](https://img.shields.io/badge/VORTEX-Public%20Architecture-0A66C2?style=for-the-badge)](#genel-mimari)
[![Güvenlik](https://img.shields.io/badge/Güvenlik-Owner%20Isolation-EA4AAA?style=for-the-badge)](#kimlik-doğrulama)
[![Ana Sayfa](https://img.shields.io/badge/README-Ana%20Sayfa-2EA44F?style=for-the-badge&logo=github)](README.md)

[← Ana README](README.md) · [Kurulum](SETUP.md) · [Takım](TEKNOFESTTEAM.md) · [Hermes Worker](VORTEX_HERMES_WORKER_README.md)
...
> [!NOTE]
> Bu belge public mimariyi açıklar. Private WSL Hermes Worker operasyonları için [`VORTEX_HERMES_WORKER_README.md`](VORTEX_HERMES_WORKER_README.md) kullanılmalıdır.
...
| Belge | İçerik |
| --- | --- |
| [`README.md`](README.md) | Projenin ana tanıtım sayfası |
| [`SETUP.md`](SETUP.md) | Yerel kurulum ve doğrulama akışı |
| [`TEKNOFESTTEAM.md`](TEKNOFESTTEAM.md) | Takım, görev dağılımı ve TEKNOFEST yolculuğu |
| [`VORTEX_HERMES_WORKER_README.md`](VORTEX_HERMES_WORKER_README.md) | Private Worker operasyonları |
| [`Vortex.HermesWorker/HermesWorker.md`](Vortex.HermesWorker/HermesWorker.md) | Worker bileşen geliştirme rehberi |
