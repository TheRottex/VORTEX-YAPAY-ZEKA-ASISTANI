...
<img src="images/partners/vortexlogo.png" alt="VORTEX logosu" height="118" />
...
[![TEKNOFEST 2026](https://img.shields.io/badge/TEKNOFEST-2026-00A6D6?style=for-the-badge)](TEKNOFESTTEAM.md)
[![.NET 8](https://img.shields.io/badge/.NET-8.0-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)](VortexAI.Public.sln)
[![Public Source](https://img.shields.io/badge/Public-Source--First-2EA44F?style=for-the-badge&logo=github)](#public-depo-sınırı)
[![Güvenlik](https://img.shields.io/badge/Güvenlik-Öncelikli-EA4AAA?style=for-the-badge)](SECURITY.md)
...
flowchart LR
    F[Fikir] --> A[Araştırma]
    A --> P[Prototipleme]
    P --> T[Test ve geri bildirim]
    T --> I[İyileştirme]
    I --> Y[Yayın ve dokümantasyon]
    Y -. sürekli gelişim .-> A
```
...
[![Takımı ve TEKNOFEST yolculuğunu inceleyin](https://img.shields.io/badge/Takım%20ve%20TEKNOFEST-Ayrıntıları%20Görüntüle-00A6D6?style=for-the-badge)](TEKNOFESTTEAM.md)
...
[![Takım yönetimini ve görev dağılımını aç](https://img.shields.io/badge/TEKNOFESTTEAM.md-Takım%20Yönetimi-6F42C1?style=for-the-badge)](TEKNOFESTTEAM.md)
...
[![Destekçilerimizi görüntüleyin](https://img.shields.io/badge/🤝%20Project%20Supporters-Destekçilerimiz-2EA44F?style=for-the-badge)](%F0%9F%A4%9D%20Project%20Supporters.md)
...
<p align="center">
  ...
  <picture>
    <img src="images/interface/raw/vortex-orb.png" alt="Sesli komut algılandığında ana ekranda görünen VORTEX ORB" width="48%" />
  </picture>
</p>
...
[![Kurulum rehberini aç](https://img.shields.io/badge/SETUP.md-Kurulum%20Rehberi-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)](SETUP.md)
...
```mermaid
flowchart LR
    B[Tarayıcı] --> W[Vortex.Web]
    W --> S[Vortex.Server.Public]
    S --> DB[(SQLite)]
    S --> J[Sahiplik kapsamlı device-job akışı]
```
...
[![Mimariyi inceleyin](https://img.shields.io/badge/ARCHITECTURE.md-Sistem%20Mimarisi-0A66C2?style=for-the-badge)](ARCHITECTURE.md)
