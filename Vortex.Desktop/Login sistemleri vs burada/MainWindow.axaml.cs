...
public sealed partial class MainWindow : Window
{
    ...
    {
        if (e.PropertyName is nameof(MainWindowViewModel.IsAuthenticated) && _viewModel?.IsAuthenticated == true)
        {
            RestoreMainWindow();
        }
    ...
    private void UpdateResponsiveLayout()
    {
        ...
        {
            AuthenticatedShell.ColumnDefinitions[2].Width = new GridLength(360, GridUnitType.Pixel);
    ...
    private void ApplyVoiceModeLayout()
    {
        ...
        else
        {
            ...
            RightPanel.IsVisible = true; // Let UpdateResponsiveLayout handle it
            UpdateResponsiveLayout();
        }
    }
